<?php include "head.php" ?>
    ...
    <section class="form-address">
        <div class="main-form-address">
            <div class="form-address-box">
                <h1 data-aos="fade-down" data-aos-duration="1000">Let's bridge <br>
                your vision <br>
                to     
            </h1> <br>
            <p data-aos="fade-down" data-aos-duration="1100">Reach out to us.</p>
            </div>
            <div class="form-address-box">
                <h4 data-aos="fade-up" data-aos-duration="1000">Write To Us</h4>
                <div class="row gx-0">
                    <div class="col-lg-12">
                    <form data-aos="fade-up" data-aos-duration="1100">
                        <div class="row g-3">
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="your-name" placeholder="First Name" name="your-name" required>
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="your-surname" placeholder="Last Name" name="your-surname" required>
                        </div>
                        <div class="col-md-6 mt-30">
                            <input type="email" class="form-control" id="your-email" placeholder="Email" name="your-email" required>
                        </div>
                        <div class="col-md-6 mt-30">
                            <input type="number" class="form-control" id="your-subject" placeholder="Mobile" name="your-subject" pattern="[1-9]{1}[0-9]{9}">
                        </div>
                        <div class="col-md-12 mt-30">
                            <textarea class="form-control" id="your-message" name="your-message" placeholder="Message" rows="5" required></textarea>
                        </div>
